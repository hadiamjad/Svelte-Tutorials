...
var app = (function () {
    ...
    /* src/FirstComponent.svelte generated by Svelte v3.42.2 */

    const file$1 = "src/FirstComponent.svelte";
    ...
    // (6:0) {#each fruits as fruit}
    function create_each_block(ctx) {
    	let div;
    	let t0_value = /*fruit*/ ctx[1] + "";
    	let t0;
    	let t1;
    	let br;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 6, 4, 97);
    			add_location(br, file$1, 6, 43, 136);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(6:0) {#each fruits as fruit}",
    		ctx
    	});
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	validate_slots('FirstComponent', slots, []);
    	let fruits = ['Apple', 'Banana', 'Oranges'];
    	const writable_props = [];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<FirstComponent> was created with unknown prop '${key}'`);
    	});
    ...
    function create_fragment(ctx) {
    	...
    	let firstcomponent;
    	let current;
    	firstcomponent = new FirstComponent({ $$inline: true });
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			...
    			mount_component(firstcomponent, main, null);
    			current = true;
    		},
    		p: noop,
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ FirstComponent });
    	return [];
    }
